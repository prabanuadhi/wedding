...
<head> 
    ...
    <link rel="icon" href="{{ URL::to('/') }}/assets/icon.png" type="image/x-icon">
...
<body>
    <svg id="on" onclick="mute('y')" xmlns="http://www.w3.org/2000/svg" version="1.0"  width="500" height="500" viewBox="0 0 75 75">
    ...
    <svg id="off" onclick="mute('n')" xmlns="http://www.w3.org/2000/svg" version="1.0" width="500" height="500" viewBox="0 0 75 75" stroke="#111" stroke-width="5">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 px-lg-2 col-xl-6 px-xl-0 px-xxl-3">
                                        ...
                                        <form class="w-100 p-lg-4 p-md-4 p-sm-0 pt-0 kontensec4">
                                            ...
                                            <div class="mb-3 text-center">
                                                <h6 ng-show="result === 'd'" class="text-danger">Pastikan seluruh data sudah diisi</h6>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="detailkado k1">
                                                        ...
                                                        <div class="kodekado"><span id="cm">900001069257</span> <div class="btn btn-sm btn-rsvp btn-copy" id="tcm"  ng-click="copyk('m')" onclick="copyToClipboard('cm', 'tcm')">copy</div></div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="detailkado k2">
                                                        ...
                                                        <div class="kodekado"><span id="cd">085826673856</span> <div class="btn btn-sm btn-rsvp btn-copy" id="tcd"  ng-click="copyk('d')" onclick="copyToClipboard('cd', 'tcd')">copy</div></div>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="detailkado k3">
                                                        ...
                                                        <div class="kodekado"><span id="cb">1070246020</span> <div class="btn btn-sm btn-rsvp btn-copy" id="tcb"  ng-click="copyk('b')" onclick="copyToClipboard('cb', 'tcb')">copy</div></div>
                                    ...
                                    <div class="col-12 px-lg-2 px-xl-0 px-xxl-3">
                                        <div class="container pt-3 vertical-scrollable rounded-3 doadoa"> 
                                            <div class="row text-center">
                                                <div class="col-lg-12 col-md-12 col-sm-12 por-pl-0">
                                                    <div class="ng-cloak" ng-if="!salam">
                                                        Loading Data . . .
                                                    </div>
                                                </div> 
                                                <div class="col-lg-6 col-md-6 col-sm-12 por-pl-0">
                                                    <div class="container">
                                                        <div class="row ng-cloak" ng-repeat="p in salam">
                                                            <div class="col-12 p-2 m-2 ucapan bb" ng-if="($index+1)%2 !== 0">
                                                                <p>"{~ p.pesan ~}"</p>
                                                                <h4>{~ p.nama ~}</h4>
                                                            </div>
                                                        </div>
                    ...
                    <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="detailkado k1">
                                            ...
                                            <div class="kodekado"><span id="mcm">900001069257</span>
                                                <div class="btn btn-sm btn-rsvp btn-copy" id="mtcm"  ng-click="copyk('m')" onclick="copyToClipboard('mcm', 'mtcm')">copy</div>
                                            </div>
                                            <div class="namakado">Mandiri a.n Alfath Prabanuadhi</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="detailkado mt-3">
                                            ...
                                            <div class="kodekado"><span id="mcd">085826673856</span>
                                                <div class="btn btn-sm btn-rsvp btn-copy" id="mtcd" ng-click="copyk('d')"  onclick="copyToClipboard('mcd', 'mtcd')">copy</div>
                                            </div>
                                            <div class="namakado">Dana a.n Alfath Prabanuadhi</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="detailkado mt-3">
                                            ...
                                            <div class="kodekado"><span id="mcb">1070246020</span>
                                                <div class="btn btn-sm btn-rsvp btn-copy" id="mtcb"  ng-click="copyk('k')" onclick="copyToClipboard('mcb', 'mtcb')">copy</div>
                                            </div>
                                            <div class="namakado">BCA a.n Ni Putu Desya Esprillia</div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 p-0 sec5part" id="igfilter">
                            ...
                            <div id="descigfilter">
                                ...
                                <a href="{{ URL::to('/') }}/filter" target="_blank" class="btn btn-outline-danger">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-instagram"
                                        viewBox="0 0 16 16">
                                        <path
                                            d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.917 3.917 0 0 0-1.417.923A3.927 3.927 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.916 3.916 0 0 0 1.416-.923c.445-.445.718-.891.923-1.417.197-.509.332-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.445-.048-3.299c-.04-.851-.175-1.433-.372-1.941a3.926 3.926 0 0 0-.923-1.417A3.911 3.911 0 0 0 13.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 10.172 0 7.998 0h.003zm-.717 1.442h.718c2.136 0 2.389.007 3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599.28.28.453.546.598.92.11.281.24.705.275 1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.47 2.47 0 0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.478 2.478 0 0 1-.92-.598 2.48 2.48 0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233 0-2.136.008-2.388.046-3.231.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92.28-.28.546-.453.92-.598.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045v.002zm4.988 1.328a.96.96 0 1 0 0 1.92.96.96 0 0 0 0-1.92zm-4.27 1.122a4.109 4.109 0 1 0 0 8.217 4.109 4.109 0 0 0 0-8.217zm0 1.441a2.667 2.667 0 1 1 0 5.334 2.667 2.667 0 0 1 0-5.334">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 p-0 sec5part" id="solotour">
                            ...
                            <div id="descwtdinsolo">
                                ...
                                <a href="{{ URL::to('/') }}/wtdsolo" target="_blank" class="btn btn-outline-danger">
        ...
        <div class="container">
            ...
            <div id="gallery" class="photos-grid-container gallery">
                <div class="main-photo img-box">
                    <a href="{{ URL::to('/') }}/assets/g4.jpg" class="glightbox" data-glightbox="type: image"><img src="{{ URL::to('/') }}/assets/sg4.jpg" alt="image" /></a>
                </div>
                <div>
                    <div class="sub">
                    ...
                    <div class="img-box"><a href="{{ URL::to('/') }}/assets/g1.jpg" class="glightbox" data-glightbox="type: image"><img src="{{ URL::to('/') }}/assets/sg1.jpg" alt="image" /></a></div>
                ...
                <div id="more-img" class="extra-images-container hide-element">
                    <a href="{{ URL::to('/') }}/assets/g6.jpg" class="glightbox" data-glightbox="type: image"><img src="{{ URL::to('/') }}/assets/g6.jpg" alt="image" /></a>
                    <a href="{{ URL::to('/') }}/assets/g7.jpg" class="glightbox" data-glightbox="type: image"><img src="{{ URL::to('/') }}/assets/g7.jpg" alt="image" /></a>
                    <a href="{{ URL::to('/') }}/assets/g8.jpg" class="glightbox" data-glightbox="type: image"><img src="{{ URL::to('/') }}/assets/g8.jpg" alt="image" /></a>
    ...
    <audio loop id="audio" src="{{ URL::to('/') }}/assets/song.ogg"></audio>
    ...
    <script>
        ...
        app.controller('ADController', function ($scope, $timeout, $http) {
            $scope.nama = '';
            $scope.rsvp = '';
            $scope.pesan = '';
            @if($nama != '')
            ...
            function getRSVP() {
                $http.post("{{ route('get-rsvp') }}", '')
                    .then(function (response) {
                        if(response.data.status === 'S'){
                            $scope.salam = response.data.data;
                        }
            ...
            $scope.submitRSVP = function() {
                ...
                if($scope.nama === '' || $scope.rsvp === '' || $scope.pesan === '') {
                    $scope.result = 'd';
                    $timeout(function () {
                        $scope.loading = false;
                        $scope.result = 'x';
                    ...
                    $http.post("{{ route('submit-rsvp') }}", JSON.stringify(data)).then(function (response) {
                        $scope.loading = false;
                        if(response.data.status === 'S'){
                            $scope.result = 'y';
                            var temp = $scope.salam.slice().reverse();
                            temp.push(data);
                            $scope.salam = temp.slice().reverse();
                        } else {
                            $scope.result = 'n';
                        }
                        $timeout(function () {
            ...
            $scope.copyk = function(jenis) {
                var tempnama = '{{$tamu}}';
                if($scope.nama !== '') tempnama = $scope.nama;
                var data = {
                    nama: tempnama,
                    jenis: jenis
                }
                
                $http.post("{{ route('submit-kado') }}", JSON.stringify(data)).then(function (response) {
                }).catch(function (error) {
                    var errorMsg = error.data.message;
                });
            }
